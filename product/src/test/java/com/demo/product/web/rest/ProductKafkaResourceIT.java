...
import com.demo.product.ProductApp;
import com.demo.product.config.SecurityBeanOverrideConfiguration;
...
public class ProductKafkaResourceIT {
    ...
    @BeforeEach
    public void setup() {
        ProductKafkaResource kafkaResource = new ProductKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/product-kafka/publish?message=test"))
